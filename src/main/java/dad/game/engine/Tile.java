...
public class Tile {
    ...
    public static int[][] tileMap6 = {
            {80, 44, 44, 46, 93, 93, 47, 44, 44, 44, 44, 44, 44, 44, 79},
            ...
            {81, 59, 59, 59, 59, 59, 59, 59, 60, 92, 92, 58, 59, 59, 78},
    };

    public static int[][] tileMap7 = {
            {80, 44, 44, 46, 95, 95, 47, 44, 44, 44, 44, 44, 44, 44, 79},
            {61, 63, 64, 65, 43, 43, 63, 64, 64, 64, 64, 64, 64, 65, 57},
            ...
            {81, 59, 59, 60, 94, 94, 58, 59, 59, 59, 59, 59, 59, 59, 78},
    };
    ...
    public static int[][] tileMap8 = {
            ...
            {97, 31, 31, 31, 31, 31, 27, 27, 27, 27, 10, 16, 16, 16, 16},
            {97, 35, 35, 35, 29, 33, 26, 26, 26, 49, 26, 26, 26, 49, 26},
            {26, 36, 26, 26, 29, 33, 26, 26, 26, 36, 26, 26, 26, 26, 26},
            {49, 26, 26, 26, 29, 33, 26, 26, 26, 26, 26, 26, 36, 26, 26},
            {26, 26, 39, 38, 96, 96, 39, 19, 19, 38, 26, 26, 26, 26, 26},
    };
            ...
            for (int j = 0; j < mapWidth; j++) {
                ...
                switch (tileMap[i][j]) {
                    ...
                    case 92:
                        ...
                        break;
                    case 93:
                        entities.add(new Map7Transition(j * tileWidth, i * tileLength));
                        break;
                    case 94:
                        entities.add(new Map7TransitionBack(j * tileWidth, i * tileLength));
                        break;
                    case 95:
                        entities.add(new Map8Transition(j * tileWidth, i * tileLength));
                        break;
                    case 96:
                        entities.add(new Map8TransitionBack(j * tileWidth, i * tileLength));
                        break;
                    case 97:
                        entities.add(new Map9Transition(j * tileWidth, i * tileLength));
                        break;
